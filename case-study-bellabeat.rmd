...
This case study explores a data analysis project for a high-tech
...
tracker smart devices. The company's co-founder and Chief Creative
Officer (CCO), Urška Sršen, believes that such analysis could unlock new
growth opportunities for the company.

Based on the analysis and the recommendation presented to the executive
team, the marketing team will then create a new marketing strategy to
unlock any potential growth for the company.
...
For this project, I chose to use R, as I find it more challenging and
versatile.
...
-   Urška Sršen, co-founder and CPO
...
Let's begin by loading these R packages.
...
We can see that covering a greater distance (on average, daily) doesn’t
...
<center><font size="2"> **Thank you for taking the time to read through this case study! I look forward to your comments with any criticism and/or questions, and please upvote if you enjoyed. Keep reading on for a few thank you's and citations. **</font> </center>

# Gratitudes and Citations

## Gratitudes

A special thanks to [Miguel Fzzz](https://www.kaggle.com/miguelfzzz), whose own [work](https://www.kaggle.com/code/miguelfzzz/bellabeat-data-analysis-discovering-trends/report) was a great guide for me.
...
* Pedersen T, Robinson D (2022). _gganimate: A Grammar of Animated Graphics_. R package version 1.0.8,
...
* Xie Y (2023). _knitr: A General-Purpose Package for Dynamic Report Generation in R_. R package version 1.45,
  ...
  Yihui Xie (2014) knitr: A Comprehensive Tool for Reproducible Research in R. In Victoria Stodden, Friedrich Leisch and Roger
  D. Peng, editors, Implementing Reproducible Computational Research. Chapman and Hall/CRC. ISBN 978-1466561595
  
*  Ooms J, Kornel Lesiński, Authors of the dependency Rust crates (2023). _gifski: Highest Quality GIF Encoder_. R package
  version 1.12.0-2, <https://CRAN.R-project.org/package=gifski>.
...
* Simon Garnier, Noam Ross, Robert Rudis, Antônio P. Camargo, Marco Sciaini, and Cédric Scherer (2023). viridis(Lite) -
